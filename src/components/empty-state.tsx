...
import { ExternalLink, type LucideIcon, Plus } from "lucide-react";
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="49.873" cy="66.361" r="8" fill="currentColor" className="text-primary/5" />
      <circle cx="280.75" cy="127.547" r="10" fill="currentColor" className="text-primary/5" />
      <circle cx="108.568" cy="168.869" r="10" fill="currentColor" className="text-primary/5" />
      <circle cx="202.627" cy="187.555" r="3" fill="currentColor" className="text-muted-foreground/20" />
      <circle cx="77.154" cy="171.156" r="3" fill="currentColor" className="text-muted-foreground/20" />
      <circle cx="66.824" cy="164.27" r="3" fill="currentColor" className="text-muted-foreground/20" />
      <circle cx="60.824" cy="118.27" r="3" fill="currentColor" className="text-muted-foreground/20" />
      <circle cx="217.551" cy="186.406" r="3" fill="currentColor" className="text-muted-foreground/20" />
      <path
...
export function EmptyState({ title, description, icon: Icon, illustration, action, link, className }: EmptyStateProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <p className="mx-auto max-w-[420px] text-muted-foreground mb-8">{description}</p>
