...
import { PublicProfileSettingsClient } from "../_components/public-profile-settings-client";
          ...
          <div className="relative max-w-4xl space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm text-zinc-600 leading-7 sm:text-base">
                Kelola data akun, atur informasi pribadi, dan perbarui keamanan profil dari satu tempat.
              </p>
            </div>
          </div>
        </section>
