    ...
    return (
      <div className="flex h-[calc(100vh-theme(spacing.24))] flex-col items-center justify-center space-y-4">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Silakan login untuk mengakses halaman profil.</p>
        </div>
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 p-8">
      <div>
        ...
        <p className="text-muted-foreground">Kelola profil pribadi, keamanan, dan preferensi antarmuka Anda.</p>
      </div>
