...
export default function PropertyDetailPage() {
  ...
  const manualPaymentAccountMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success(
        editingAccount
          ? "Rekening pembayaran manual berhasil diperbarui."
          : "Rekening pembayaran manual berhasil ditambahkan.",
      );
    ...
    <div className="flex-1 space-y-6 p-8 pt-6">
            ...
            <div className="flex space-x-2 ml-4">
              ...
              {propertyData.status === "APPROVED" && (
                <Button
                  ...
                  onClick={() => approveMutation.mutate("DEACTIVATED")}
                >
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Tindakan ini tidak dapat dibatalkan. Semua data terkait properti ini, termasuk tipe kamar dan unit,
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          <PropertyGallery images={propertyData.images} propertyName={propertyData.name} />
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    {isLoadingRoomTypes
                      ...
                      : (Array.isArray(roomTypesData) ? roomTypesData : []).map((type: any) => {
                          const thumbnail =
                            type.images?.find((img: any) => img.category === "BEDROOM")?.url ||
                            type.images?.[0]?.url ||
                              ...
                              <div className="relative h-44 w-full overflow-hidden">
                                ...
                                <Badge
                                  className={`absolute top-3 left-3 ${
                                    type.genderCategory === "WOMAN"
                                      ? "bg-pink-500/90 hover:bg-pink-500"
                                      : type.genderCategory === "MAN"
                              ...
                              <div className="p-4 space-y-1">
                                ...
                                <div className="flex flex-wrap gap-1.5 pt-3 mt-2 border-t">
                                  {(type.roomFacilities?.slice(0, 3) || []).map((fac: string, i: number) => (
                                    <span
                                      key={i}
                                      className="text-[9px] font-bold text-muted-foreground bg-muted/80 px-2 py-0.5 rounded uppercase"
                                    >
                                      {fac}
                                    </span>
                                  ))}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {new Date(propertyData.createdAt).toLocaleDateString("id-ID")}
                      </p>
                    </div>
                  </div>
                  <Separator />
      ...
      >
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>
              {editingAccount ? "Edit Rekening Pembayaran Manual" : "Tambah Rekening Pembayaran Manual"}
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setAccountForm((prev) => ({ ...prev, displayPriority: Number(event.target.value) || 1 }))
                  }
                />
              </div>
            </div>
            <div className="flex items-center justify-between rounded-lg border px-4 py-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  Jika aktif, rekening ini akan muncul sebagai pilihan pembayaran manual.
                </div>
              </div>
              <Switch
          ...
          <DialogFooter>
            <Button
              ...
              disabled={manualPaymentAccountMutation.isPending}
            >
              Batal
            </Button>
            <Button
