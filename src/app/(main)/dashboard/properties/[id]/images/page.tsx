        ...
        <form onSubmit={form.handleSubmit((values) => updateMutation.mutate(values))} className="space-y-6 max-w-4xl">
          <Card className="border-none shadow-md">
            <CardHeader className="py-4">
              ...
              <CardDescription className="text-xs">Ubah foto tampak depan atau keseluruhan bangunan.</CardDescription>
            </CardHeader>
          ...
          <Card className="border-none shadow-md">
            <CardHeader className="py-4">
              ...
              <CardDescription className="text-xs">Ubah foto area parkir kendaraan.</CardDescription>
            </CardHeader>
            <CardContent className="pb-6 pt-0">
              <FormField
                control={form.control}
