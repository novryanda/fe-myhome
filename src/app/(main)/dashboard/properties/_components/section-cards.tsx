...
import { AlertCircle, Clock, Home, TrendingUp } from "lucide-react";
    ...
    <div className="grid grid-cols-1 gap-4 px-4 lg:px-6 sm:grid-cols-2 lg:grid-cols-3">
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">Total hunian dalam ekosistem</div>
        </CardFooter>
      </Card>
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">Menunggu antrean review</div>
        </CardFooter>
      </Card>
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">Properti ditolak</div>
        </CardFooter>
      </Card>
    </div>
  );
