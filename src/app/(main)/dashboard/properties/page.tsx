...
export default function PropertiesPage() {
  ...
  const filteredProperties =
    statusFilter === "ALL" ? allProperties : allProperties.filter((p: any) => p.status === statusFilter);
      ...
      {isSuperAdmin && !isLoading && (
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground italic">
