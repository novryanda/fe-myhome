...
import { Plus, RefreshCcw, Search, ShieldAlert, Users } from "lucide-react";
...
import { getColumns, SectionCards, type User, UserFormModal } from "./_components";
    ...
    return (
      <div className="flex h-[calc(100vh-theme(spacing.24))] flex-col items-center justify-center space-y-4">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Hanya Superadmin yang memiliki akses ke halaman manajemen user.</p>
        </div>
      ...
      <AlertDialog open={!!userToDelete} onOpenChange={(open) => !open && setUserToDelete(undefined)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini akan menghapus akun <span className="font-semibold">{userToDelete?.name}</span> secara
      ...
      <AlertDialog open={!!userToSuspend} onOpenChange={(open) => !open && setUserToSuspend(undefined)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Akun <span className="font-semibold">{userToSuspend?.name}</span> akan dinonaktifkan sementara. Pengguna
              tidak akan bisa masuk ke aplikasi.
            </AlertDialogDescription>
          </AlertDialogHeader>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-semibold">{userToUnban?.name}</span>?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Batal</AlertDialogCancel>
