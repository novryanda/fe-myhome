...
import { AlignLeft, Banknote, ImageIcon, Loader2, Maximize, Type, Upload, Users } from "lucide-react";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit((v) => updateMutation.mutate(v))} className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          {imageUrls.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed py-12 text-center">
              ...
              <p className="text-xs text-muted-foreground/60 mt-1">Upload gambar kamar untuk ditampilkan</p>
            </div>
          ) : null}
          <ImageUpload value={imageUrls} onUpload={handleImageUpload} onRemove={handleImageRemove} maxImages={8} />
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Ukuran Kamar <span className="text-muted-foreground font-normal">(opsional)</span>
                </FormLabel>
                <FormControl>
                  <div className="relative">
        ...
        <div className="flex justify-end">
          <Button type="submit" disabled={updateMutation.isPending || !form.formState.isDirty} variant="preset">
